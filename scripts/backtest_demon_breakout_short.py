...
OUTPUT_DIR = PROJECT / "deliverables/demon-breakout-short"
    ...
    for ts in timeline:
        ...
        for trade in open_trades:
            ...
            if exit_reason:
                ...
                exit_fee = trade.amount * exit_price * fee_rate
        ...
        for _, pair, tag in due:
            ...
            open_trades.append(
                OpenShort(pair, ts, entry_price, stake, stake / entry_price, entry_price, entry_price, tag)
            )
        ...
        for pair, df in index_by_pair.items():
            ...
            if not next_rows.empty:
                pending_entries.append((next_rows.iloc[0]["date"], pair, "inverse_breakout_short"))
